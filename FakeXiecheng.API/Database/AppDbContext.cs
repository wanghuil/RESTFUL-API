...
namespace FakeXiecheng.API.Database
{
    public class AppDbContext : IdentityDbContext<ApplicationUser> //DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Initialize seed data for users and roles
            // 1.Update the foreign key relationship between users and roles
            ...
            // 4. Add administrator permissions to users
            // using linking table：IdentityUserRole
